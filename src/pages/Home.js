        ...
        <div className='col'>
            <div className='row'>
                <div className='intro'>
                    ...
                    <p >I'm currently working in <a className='link' target='_blank' href='http://agilesolutions.com/'>Agile Solutions</a> brazil based enterprise company as Senior User Experience Design. Most of my  previous work reflects with B2B Solutions in the area of Manufacturing, Fintech and many other sectors.</p>
                ...
                <div className='pastExpereince'>
                    ...
                    <div className='experience-row'>
                        <div className='expereince-lineitems'>
                            <a className='link' target='_blank' href='http://agilesolutions.com/' >Agile Solutions (Brazil/India) </a>
                        ...
                        <div className='expereince-lineitems'>
                            <a className='link' target='_blank' href='http://agilesolutions.com/' >Agile Solutions (Brazil) </a>
                            <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <div className="desgPeriod">
                        ...
                        <div className='expereince-lineitems' >
                            <a className='link' target='_blank' href='https://incture.com/' >Incture (Bngl, India)</a>
                            <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <div className="desgPeriod">
                                <h4 style={{textAlign:'right'}} >Designer</h4>
                ...
                <div className='socialMedia'>
                    ...
                    <div className='social-row'>
                        <div className='social-lineitems'>
                            <h4 >Dribbble </h4>
                            <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <a className='link' target='_blank' href='https://dribbble.com/manoharmanu'>Follow</a>

                        </div>
                        <div className='social-lineitems'>
                        <h4 >Behance </h4>
                           <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <a className='link' target='_blank' href='https://www.behance.net/manoharmande31'>Follow</a>
                        </div>
                        <div className='social-lineitems' >
                            <h4 >Twitter </h4>
                            <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <a target='_blank' href="https://twitter.com/manoharmanu4444?ref_src=twsrc%5Etfw" className="twitter-follow-button link" data-show-count="false">Follow</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                        </div>
                        <div className='social-lineitems'>
                            <h4 >Linkedin </h4>
                            <div style={{flexGrow:1,borderBottom:'dotted 2px #ffffff60'}}></div>
                            <a target='_blank' className='link' href='https://www.linkedin.com/in/manoharmanu4444/'>Connect</a>
                        </div>
                    </div>
                </div>
            </div>
